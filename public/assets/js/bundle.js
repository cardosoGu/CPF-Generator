...
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAAA;IACI,sBAAsB;IACtB,UAAU;AACd;AACA;IACI,UAAU;IACV,SAAS;IACT,2BAA2B;;IAE3B,uBAAuB;IACvB,gBAAgB;AACpB;;;AAGA;IACI,2BAA2B;IAC3B,aAAa;IACb,mBAAmB;IACnB,YAAY;IACZ,aAAa;;AAEjB","sourcesContent":["*{\r\n    box-sizing: border-box;\r\n    outline: 0;\r\n}\r\nbody{\r\n    padding: 0;\r\n    margin: 0;\r\n    background-color:aquamarine;\r\n   \r\n    font-family: sans-serif;\r\n    font-size: 1.5em;\r\n}\r\n\r\n\r\n.tudo{\r\n    background-color: aliceblue;\r\n    border: solid;\r\n    border-radius: 50px;\r\n    margin: 90px;\r\n    padding: 60px;\r\n\r\n}"],"sourceRoot":""}]);
// Exports
...
var GeraCpf = /*#__PURE__*/function () {
  ...
  return _createClass(GeraCpf, [{
    ...
    value: function newCPf() {
      ...
      var digito1 = _validaCpf__WEBPACK_IMPORTED_MODULE_0__["default"].digito(cpfSemDigito);
      var digito2 = _validaCpf__WEBPACK_IMPORTED_MODULE_0__["default"].digito(cpfSemDigito + digito1);
...
var Cpf = /*#__PURE__*/function () {
  ...
  return _createClass(Cpf, [{
    ...
    value: function sequencia() {
      var cpfSequencia = this.cpfLimpo[0].repeat(this.cpfLimpo.length);
    ...
    value: function validar() {
      ...
      var digito1 = this.digito(cpfSemDigito);
      var digito2 = this.digito(cpfSemDigito.concat(digito1));
      var cpfFinal = cpfSemDigito.concat(digito1, digito2);
      return cpfFinal === this.cpfLimpo;
    }
  }, {
    key: "digito",
    value: function digito(cpf) {
      //logica
      var logica = _toConsumableArray(cpf).map(function (e, x) {
        return e * (cpf.length + 1 - x);
      }).reduce(function (acum, val) {
        return acum += val;
      });
      var digito = 11 - logica % 11;
      //retorna
...
(function () {
  ...
  var gerar = new _modules_geraCpf__WEBPACK_IMPORTED_MODULE_0__["default"]();
